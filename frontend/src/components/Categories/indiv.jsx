...
const Indiv = ({ Category, setContent }) => {
  return (
    <>
      <div className="main-container z-0">
        <div className="container-up">
          <div className="up-1">
            ...
            <h1 className="text-6xl text-white pb-5">Chat GPT</h1>
          </div>
          <div>
            <p className="text-l text-white pb-5">
              ChatGPT es un modelo de lenguaje basado en la arquitectura GPT
              (Generative Pre-trained Transformer) desarrollado por OpenAI. Es
              parte de una familia de modelos de inteligencia artificial (IA)
              diseñados para generar texto en lenguaje natural. Aquí tienes un
              resumen de su tecnología y funcionalidad:
            </p>
          </div>
          <Rankings />
        </div>
